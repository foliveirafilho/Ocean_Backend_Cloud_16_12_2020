...
const connectionString = 'mongodb+srv://admin:wlCgAzJLBv8l9eJP@cluster0.dpwew.mongodb.net/<dbname>?retryWrites=true&w=majority';
...
const db = client.db('ocean_backend_cloud');
